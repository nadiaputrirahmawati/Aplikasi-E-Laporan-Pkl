<div
    ...
    <ul class="w-full pl-4 flex flex-col h-fit">
        <li class="group relative {{ request()->is('operator') ? 'active rounded-s-full text-black' : 'text-black' }}">
            <a href="/operator" class="flex items-center py-3 px-4 text-slate-50 relative">
                <span class="mr-6">
        ...
        <li class="group relative {{ request()->is('operator/guru') ? 'active rounded-s-full' : '' }}">
            <a href="/operator/guru" class="flex items-center py-3 px-4 text-slate-50 relative">
                <span class="mr-6">
                    <i class="fa-duotone fa-regular fa-screen-users text-xl"></i>
                </span>
                <span class="text-lg sidebar-text font-semibold">Guru</span>
            </a>
        </li>
        <li class="group relative {{ request()->is('operator/siswa') ? 'active rounded-s-full' : '' }}">
            <a href="/operator/siswa" class="flex items-center py-3 px-4 text-slate-50 relative">
                <span class="mr-6">
                    <i class="fa-regular fa-clipboard-list text-3xl"></i>
                </span>
                <span class="text-lg sidebar-text font-semibold"> Siswa</span>
            </a>
        </li>
    </ul>
