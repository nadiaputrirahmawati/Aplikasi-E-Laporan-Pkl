<nav id="navbar"
    class="bg-base-100 fixed top-0 lg:left-64 left-0 right-0 h-16 flex items-center px-6 z-30 lg:shadow-none shadow-lg">
    <div class="flex justify-between w-full">
        <div class="text-2xl font-bold text-primary  lg:space-x-0 space-x-32">
            <div class=" mt-2">
                {{ $title ?? 'E-LAPORAN PKL' }}
            </div>
        </div>
        ...
        <div class=" items-center space-x-3 pr-4  text-neutral flex"> <!-- This will hide on mobile -->
            ...
            <div class="avatar  items-center space-x-2 hidden md:flex">
                <h1 class="text-bold">Hi, Nadia</h1>
