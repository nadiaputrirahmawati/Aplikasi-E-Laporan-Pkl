<div
    ...
    <div class="mb-8">
        ...
        <h1 class="text-white text-2xl font-semibold sidebar-text text-center">E - PKL</h1>
    </div>
    <ul class="w-full pl-4 flex flex-col h-fit">
        <li class="group relative {{ request()->is('students/dashboard') ? 'active rounded-s-full text-black' : 'text-black' }}">
            <a href="{{ url('/students/dashboard') }}" class="flex items-center py-3 px-4 text-slate-50 relative">
                <span class="mr-6">
        ...
        <li class="group relative {{ request()->is('students/logbook') ? 'active rounded-s-full text-black' : 'text-black' }}">
            <a href="{{ url('/students/logbook') }}" class="flex items-center py-3 px-4 text-slate-50 relative">
                <span class="mr-6">
                    <i class="fa-solid fa-books text-xl"></i>
                </span>
                <span class="text-lg sidebar-text font-semibold">Kegiatan</span>
            </a>
        </li>
        <li class="group relative {{ request()->is('students/title-report') ? 'active rounded-s-full' : '' }}">
            <a href="/students/title-report" class="flex items-center py-3 px-4 text-slate-50 relative">
                <span class="mr-6">
        ...
        <li class="group relative {{ request()->is('students/report') ? 'active rounded-s-full' : '' }}">
            <a href="/students/report" class="flex items-center py-3 px-4 text-slate-50 relative">
                <span class="mr-6">
                    <i class="fa-regular fa-clipboard-list text-3xl"></i>
                </span>
                <span class="text-lg sidebar-text font-semibold"> Laporan</span>
            </a>
        </li>
    </ul>
