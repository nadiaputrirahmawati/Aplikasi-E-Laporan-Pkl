...
<div class="modal bg-base-200">
    <div class="modal-box text-neutral w-5/12 max-w-5xl">
        <h3 class="text-lg font-bold text-center">Buat Kelas Bimbingan</h3>
        <div class="relative mt-6">
            ...
            <label for="username"
                ...
                Masukan Nama Kelas Bimbingan
            </label>
            <div class="flex justify-end space-x-4">
                <button type="submit" class="btn btn-primary text-md text-white rounded-full mt-6">Buat</button>
