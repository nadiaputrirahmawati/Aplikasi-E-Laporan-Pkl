                ...
                <div class="bg-base-content shadow-md rounded-xl">
                    <div class="flex ">
                        ...
                        <div class="p-4">
                            ...
                            <h1 class="text-neutral font-normal mt-2"> <i class="fa-duotone fa-regular fa-users mr-2"></i> 20
                                Siswa</h1>
                            <h1 class="text-neutral font-normal mt-2"> <i
                                    class="fa-duotone fa-regular fa-chalkboard-user mr-2"></i></i></i>
                                ZTMXY5</h1>
                            <a href="{{  url('/teacher/students') }}" class="text-white text-sm font-normal btn btn-sm mt-3 w-28 text-center rounded-full bg-base-200 hover:bg-primary">Klik Detail</a>
                        </div>
                    </div>
                </div>
            @endfor
